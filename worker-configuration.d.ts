/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 0fb86ea0424c517628d52694018d8f0c)
// Runtime types generated with workerd@1.20250803.0 2025-08-01 
declare namespace Cloudflare {
	interface Env {
		ENV: string;
		CAP: DurableObjectNamespace<import("./src/index").CapDO>;
		CAP_RATE_LIMITER: RateLimit;
		ASSETS: Fetcher;
	}
}
